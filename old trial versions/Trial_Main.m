...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        ...
        PlayCenterMovie(movietoplay_ambigVid{1},'border', 1);
        WaitSecs(0.50);
    ...
    if MAIN_ITEMS.BiasManner(trialNo) == 'L'
        ...
        PlaySideMovies(movietoplay_manner{1},'','border', 1);
        WaitSecs(0.50);
        Show_Blank;
        ...
        PlaySideMovies('',movietoplay_path{1},'border', 1);
        ...
        PlaySideMovies(movietoplay_manner{1},movietoplay_path{1},'border', 1);
        PlaySideMovies(movietoplay_manner{1},movietoplay_path{1},'border', 1);
    ...
    elseif MAIN_ITEMS.BiasManner(trialNo) == 'R'
        ...
        PlaySideMovies(movietoplay_path{1},movietoplay_manner{1},'border', 1);
        PlaySideMovies(movietoplay_path{1},movietoplay_manner{1},'border', 1);
...
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    PlayCenterMovie(movietoplay_trainV1{1},'border', 1); 
    WaitSecs(0.50);
    Show_Blank;
...
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    PlayCenterMovie(movietoplay_trainV2{1},'border', 1);
    WaitSecs(0.50);
    Show_Blank;
...
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    PlayCenterMovie(movietoplay_trainV3{1},'border', 1);
    WaitSecs(0.50);
    Show_Blank;
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    if MAIN_ITEMS.TestManner(trialNo) == 'L'
        ...
        PlaySideMovies(movietoplay_mTest{1},'','border', 1);
        WaitSecs(0.50);
        Show_Blank;
        ...
        PlaySideMovies('',movietoplay_pTest{1},'border', 1);
        WaitSecs(0.50);
        Show_Blank;
        ...
        PlaySideMovies(movietoplay_mTest{1},movietoplay_pTest{1},'border', 1);
        Show_Blank;
        WaitSecs(0.25);
        PlaySideMovies(movietoplay_mTest{1},movietoplay_pTest{1},'border', 1);
    ...
    elseif MAIN_ITEMS.TestManner(trialNo) == 'R'
        ...
        PlaySideMovies(movietoplay_pTest{1},movietoplay_mTest{1},'border', 1);
        Show_Blank;
        WaitSecs(0.25);
        PlaySideMovies(movietoplay_pTest{1},movietoplay_mTest{1},'border', 1);
    end
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%
        ...
        PlayCenterMovie(movietoplay_recenter, 'ownsound', 1 ,'border', 1);
        Show_Blank;
