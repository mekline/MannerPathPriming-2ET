...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    %%%%%%%%%%%%%%%%%%%%%
        ...
        timeCell(end+1,:) = timeStamp('Start_Practice_Trial');
        disp(['Start Trial: ' ])
        ...
        timeCell(end+1,:) = timeStamp('ambigAudio_Practice');
        
        Play_Sound(strcat(RESOURCEFOLDER, '/audio/aa_nouns/ball1.wav'), 'toBlock');
        
        timeCell(end+1,:) = timeStamp('ambigAudio_Practice End'); 
        ...
        timeCell(end+1,:) = timeStamp('ambigVideo_Practice'); 
        ...
        PlaySideMovies(movietoplay_practice_1_distr,'','caption_left','','border', 1);
        WaitSecs(0.50);
        ...
        PlaySideMovies('',movietoplay_practice_1e,'caption_right','','border', 1); 
        ...
        PlaySideMovies(movietoplay_practice_1_distr,movietoplay_practice_1e,'caption_left','','border', 1);
        Show_Blank;
        WaitSecs(0.25);
        PlaySideMovies(movietoplay_practice_1_distr,movietoplay_practice_1e, 'caption_left','','border', 1);
    ...
    %%%%%%%%%%%%%%%%%%%%%
        ...
        PlaySideMovies(movietoplay_practice_3e,'','caption_left','','border', 1);
        WaitSecs(0.50);
        Show_Blank;
        ...
        PlaySideMovies('',movietoplay_practice_3_distr,'caption_right','','border', 1);
        WaitSecs(0.50);
        Show_Blank;
        ...
        PlaySideMovies(movietoplay_practice_3e,movietoplay_practice_3_distr,'caption_left','','border', 1);
        Show_Blank;
        WaitSecs(0.25);
        PlaySideMovies(movietoplay_practice_3e,movietoplay_practice_3_distr,'caption_left','','border', 1);
