...
function Do_MPP_Trials(subNo, condition, extendcondition)
...
display('I EXPECT IT TO WORK UP TO HERE')
parameters.datafilepointer = AssignDataFile('MannerPathPriming',subNo);
display('AND NOW ITS TIME FOR MELISSA TO MAKE CHANGES TO PTBHELPERS');
